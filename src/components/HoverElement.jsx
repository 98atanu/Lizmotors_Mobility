...
const HoverElement = ({ data }) => {
  return (
    <motion.div
      ...
      className="hoverElement p-4 z-[999] rounded-lg w-52 h-40 absolute bg-zinc-800 text-white flex flex-col justify-center items-center shadow-lg shadow-teal-900 translate-x-[90px] -translate-y-[190px] border-[3px] border-[#14B8A5]"
    >
      <motion.div
